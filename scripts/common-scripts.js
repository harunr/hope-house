...
;(function($){
	$(function(){
        ...
        $('div.mobi-nav').click(function(){
            $('div.maing-nav').slideToggle()
            
        })
        
        $('.down-arro-link > a').click(function(e){
            e.preventDefault()
            $('html, body').stop(true, true).animate({
                scrollTop: $('#cape-colonial').offset().top - 0
            }, 1500, 'easeInOutCubic' );
        ...
        if( $('#contact-modal-section').length){
    ...
    $(window).load(function(){
        // Begin home slider
        if ( $('#modal-slider').length == 0 ) return false
